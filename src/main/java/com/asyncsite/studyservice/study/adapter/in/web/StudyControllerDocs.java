...
public interface StudyControllerDocs {
    ...
    @Operation(summary = "스터디 승인", description = "제안된 스터디를 승인합니다. (ADMIN 권한 필요)",
               security = @SecurityRequirement(name = "JWT"))
    @ApiResponses({
    ...
    @Operation(summary = "스터디 거절", description = "제안된 스터디를 거절합니다. (ADMIN 권한 필요)",
               security = @SecurityRequirement(name = "JWT"))
    @ApiResponses({
    ...
    @Operation(summary = "스터디 종료", description = "진행 중인 스터디를 종료합니다. (ADMIN 권한 필요)",
               security = @SecurityRequirement(name = "JWT"))
    @ApiResponses({
